...
> = {
  ...
  "section identity": [
    ...
    "verse into the chorus",
    "chorus or bridge",
    "before a chorus or bridge",
    "at form level",
    "verse remove snare",
    "pre chorus add",
    "chorus restore",
  ...
  build: [
    "increase predictive tension",
    "creates anticipation",
    "build anticipation",
    "withdrawal and return",
    "dropout and return",
    "remove the backbeat then return",
    "reintroduce the full backbeat",
    "strip tighten open suspend return",
    "add subdivision",
    "added subdivisions",
  ],
  context: [
